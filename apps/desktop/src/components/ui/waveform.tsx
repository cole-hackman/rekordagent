...
// Upstream source: github.com/elevenlabs/ui/apps/www/registry/elevenlabs-ui/ui/waveform.tsx
// Kept verbatim except for import-path adaptation to local aliases. Empty
// catch blocks are intentional (audio context teardown swallowing) — left
// alone so the file stays diffable against the registry.
"use client"
