...
// eslint-disable-next-line react-refresh/only-export-components -- co-locating the hook with the provider is intentional; HMR for the consumer is unaffected.
